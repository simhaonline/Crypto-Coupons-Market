...
In order to support loading of multiple wallets in cryptocoupon-qt, a few changes in the UI architecture will be needed.
...
Only requiring some minor changes is cryptocoupon.cpp.
...
Changes to cryptocoupon.cpp
----------------------
cryptocoupon.cpp is the entry point into cryptocoupon-qt, and as such, will require some minor modifications to provide hooks for
