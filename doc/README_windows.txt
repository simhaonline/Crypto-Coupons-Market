...
Intro
-----
CRYPTOCOUPON (CCM) is a sustainable cryptocurrency modeled after 
...
high-powered mining hardware. CRYPTOCOUPON utilizes an energy efficient proof-of-stake algorithm, 
...
Setup
-----
Unpack the files into a directory and run cryptocoupon-qt.exe.

CRYPTOCOUPON is the original CRYPTOCOUPON client and it builds the backbone of the network.
However, it downloads and stores the entire history of CRYPTOCOUPON transactions;
