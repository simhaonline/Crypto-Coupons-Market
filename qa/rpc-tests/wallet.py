...
#   c) node1 mines 32 blocks, so now node 0 has 500000CCM, node 1 has 4250CCM, node2 has none.
#   d) node0 sends 601 CCM to node2, in two transactions (301 CCM, then 300 CCM).
