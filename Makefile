...
pkgdatadir = $(datadir)/cryptocoupon
pkgincludedir = $(includedir)/cryptocoupon
pkglibdir = $(libdir)/cryptocoupon
pkglibexecdir = $(libexecdir)/cryptocoupon
...
CONFIG_HEADER = $(top_builddir)/src/config/cryptocoupon-config.h
...
am__DIST_COMMON = $(srcdir)/Makefile.in \
	...
	$(top_srcdir)/src/config/cryptocoupon-config.h.in \
...
ACLOCAL = ${SHELL} /home/cryptocoupon-core/build-aux/missing aclocal-1.15
AMTAR = $${TAR-tar}
AM_DEFAULT_VERBOSITY = 0
AR = /usr/bin/ar
AUTOCONF = ${SHELL} /home/cryptocoupon-core/build-aux/missing autoconf
AUTOHEADER = ${SHELL} /home/cryptocoupon-core/build-aux/missing autoheader
AUTOMAKE = ${SHELL} /home/cryptocoupon-core/build-aux/missing automake-1.15
AWK = gawk
BDB_CPPFLAGS = 
BDB_LIBS = -ldb_cxx-4.8
BITCOIN_CLI_NAME = cryptocoupon-cli
BITCOIN_DAEMON_NAME = cryptocoupond
BITCOIN_GUI_NAME = cryptocoupon-qt
BITCOIN_TX_NAME = cryptocoupon-tx
...
MAINT = 
MAKEINFO = ${SHELL} /home/cryptocoupon-core/build-aux/missing makeinfo
MAKENSIS = 
MANIFEST_TOOL = :
MINIUPNPC_CPPFLAGS = 
...
OTOOL = 
OTOOL64 = 
PACKAGE = cryptocoupon
PACKAGE_BUGREPORT = www.savebitcoin.io
PACKAGE_NAME = CRYPTOCOUPON
PACKAGE_STRING = CRYPTOCOUPON 2.0.0
PACKAGE_TARNAME = cryptocoupon
PACKAGE_URL = 
...
ZMQ_CFLAGS = 
ZMQ_LIBS = -lzmq
abs_builddir = /home/cryptocoupon-core
abs_srcdir = /home/cryptocoupon-core
abs_top_builddir = /home/cryptocoupon-core
abs_top_srcdir = /home/cryptocoupon-core
ac_ct_AR = ar
ac_ct_CC = gcc
ac_ct_CXX = g++
ac_ct_DUMPBIN = 
...
install_sh = ${SHELL} /home/cryptocoupon-core/build-aux/install-sh
...
COVERAGE_INFO = baseline_filtered_combined.info baseline.info block_test.info \
  leveldb_baseline.info test_cryptocoupon_filtered.info total_coverage.info \
  baseline_filtered.info block_test_filtered.info \
  leveldb_baseline_filtered.info test_cryptocoupon_coverage.info test_cryptocoupon.info

OSX_APP_BUILT = $(OSX_APP)/Contents/PkgInfo $(OSX_APP)/Contents/Resources/empty.lproj \
  $(OSX_APP)/Contents/Resources/bitcoin.icns $(OSX_APP)/Contents/Info.plist \
  $(OSX_APP)/Contents/MacOS/CCMcoin-Qt $(OSX_APP)/Contents/Resources/Base.lproj/InfoPlist.strings
...
src/config/cryptocoupon-config.h: src/config/stamp-h1
	@test -f $@ || rm -f src/config/stamp-h1
	@test -f $@ || $(MAKE) $(AM_MAKEFLAGS) src/config/stamp-h1

src/config/stamp-h1: $(top_srcdir)/src/config/cryptocoupon-config.h.in $(top_builddir)/config.status
	@rm -f src/config/stamp-h1
	cd $(top_builddir) && $(SHELL) ./config.status src/config/cryptocoupon-config.h
$(top_srcdir)/src/config/cryptocoupon-config.h.in:  $(am__configure_deps) 
	($(am__cd) $(top_srcdir) && $(AUTOHEADER))
	rm -f src/config/stamp-h1
	touch $@

distclean-hdr:
	-rm -f src/config/cryptocoupon-config.h src/config/stamp-h1
...
$(OSX_APP)/Contents/MacOS/CCMcoin-Qt: $(BITCOIN_QT_BIN)
	$(MKDIR_P) $(@D)
...
$(APP_DIST_EXTRAS): $(APP_DIST_DIR)/$(OSX_APP)/Contents/MacOS/CCMcoin-Qt
...
$(APP_DIST_DIR)/$(OSX_APP)/Contents/MacOS/CCMcoin-Qt: $(OSX_APP_BUILT) $(OSX_PACKAGING)
...
#test_cryptocoupon.info: baseline_filtered_combined.info
#	$(MAKE) -C src/ check
#	$(LCOV) -c -d $(abs_builddir)/src -t test_cryptocoupon -o $@
#	$(LCOV) -z -d $(abs_builddir)/src
#	$(LCOV) -z -d $(abs_builddir)/src/leveldb

#test_cryptocoupon_filtered.info: test_cryptocoupon.info
#	$(LCOV) -r $< "/usr/include/*" -o $@

#block_test.info: test_cryptocoupon_filtered.info
#	$(MKDIR_P) qa/tmp
...
#test_cryptocoupon_coverage.info: baseline_filtered_combined.info test_cryptocoupon_filtered.info
#	$(LCOV) -a baseline_filtered.info -a leveldb_baseline_filtered.info -a test_cryptocoupon_filtered.info -o $@

#total_coverage.info:  baseline_filtered_combined.info test_cryptocoupon_filtered.info block_test_filtered.info
#	$(LCOV) -a baseline_filtered.info -a leveldb_baseline_filtered.info -a test_cryptocoupon_filtered.info -a block_test_filtered.info -o $@ | $(GREP) "\%" | $(AWK) '{ print substr($$3,2,50) "/" $$5 }' > coverage_percent.txt

#test_cryptocoupon.coverage/.dirstamp:  test_cryptocoupon_coverage.info
#	$(GENHTML) -s $< -o $(@D)
#	@touch $@
...
#cov: test_cryptocoupon.coverage/.dirstamp total.coverage/.dirstamp

.INTERMEDIATE: $(COVERAGE_INFO)

clean-local:
	rm -rf test_cryptocoupon.coverage/ total.coverage/ $(OSX_APP)
