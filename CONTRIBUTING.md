Contributing to CRYPTOCOUPON
==================================

The CRYPTOCOUPON project operates an open contributor model where anyone is
...
The following applies to code changes to the CRYPTOCOUPON project, and is not to be
confused with overall CRYPTOCOUPON Network Protocol consensus changes.

Whether a pull request is merged into CRYPTOCOUPON rests with the project merge
...
Patches that change CRYPTOCOUPON consensus rules are considerably more involved than
...
Where a patch set proposes to change the CRYPTOCOUPON consensus, it must have been
...
The project leader is the release manager for each CRYPTOCOUPON release.
