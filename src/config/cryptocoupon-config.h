/* src/config/cryptocoupon-config.h.  Generated from cryptocoupon-config.h.in by configure.  */
/* src/config/cryptocoupon-config.h.in.  Generated from configure.ac by autoheader.  */
...
#define PACKAGE_NAME "CRYPTOCOUPON"

/* Define to the full name and version of this package. */
#define PACKAGE_STRING "CRYPTOCOUPON 2.0.0"

/* Define to the one symbol short name of this package. */
#define PACKAGE_TARNAME "cryptocoupon"
