                                                                            ...
                                                                            spinnerFrame(0)
{
    ...
    QString windowTitle = tr("CRYPTOCOUPON") + " - ";
#ifdef ENABLE_WALLET
...
void BitcoinGUI::createActions(const NetworkStyle* networkStyle)
{
    ...
    sendCoinsAction->setStatusTip(tr("Send coins to a CCM address"));
    ...
    receiveCoinsAction->setStatusTip(tr("Request payments (generates QR codes and cryptocoupon: URIs)"));
    ...
    aboutAction = new QAction(networkStyle->getAppIcon(), tr("&About CRYPTOCOUPON"), this);
    aboutAction->setStatusTip(tr("Show information about CRYPTOCOUPON"));
    ...
    optionsAction->setStatusTip(tr("Modify configuration options for CRYPTOCOUPON"));
    ...
    signMessageAction->setStatusTip(tr("Sign messages with your CCM addresses to prove you own them"));
    verifyMessageAction = new QAction(QIcon(":/icons/transaction_0"), tr("&Verify message..."), this);
    verifyMessageAction->setStatusTip(tr("Verify messages to ensure they were signed with specified CCM addresses"));
    ...
    openAction->setStatusTip(tr("Open a cryptocoupon: URI or payment request"));
    openBlockExplorerAction = new QAction(QIcon(":/icons/explorer"), tr("&Blockchain explorer"), this);
    openBlockExplorerAction->setStatusTip(tr("Block explorer window"));

    showHelpMessageAction = new QAction(QApplication::style()->standardIcon(QStyle::SP_MessageBoxInformation), tr("&Command-line options"), this);
    showHelpMessageAction->setMenuRole(QAction::NoRole);
    showHelpMessageAction->setStatusTip(tr("Show the CRYPTOCOUPON help message to get a list with possible CRYPTOCOUPON command-line options"));
...
void BitcoinGUI::createTrayIcon(const NetworkStyle* networkStyle)
{
    ...
    QString toolTip = tr("CRYPTOCOUPON client") + " " + networkStyle->getTitleAddText();
...
void BitcoinGUI::setNumConnections(int count)
{
    ...
    labelConnectionsIcon->setToolTip(tr("%n active connection(s) to CRYPTOCOUPON network", "", count));
}
...
{
    QString strTitle = tr("CRYPTOCOUPON"); // default title
