...
/** Utility functions used by the CCMcoin Qt UI.
 */
namespace GUIUtil
{
...
// Render CCM addresses in monospace font
...
// Parse "cryptocoupon:" URI into recipient object, return true on successful parsing
