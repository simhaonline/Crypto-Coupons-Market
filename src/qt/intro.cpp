...
bool Intro::pickDataDirectory()
{
    ...
    if (!fs::exists(GUIUtil::qstringToBoostPath(dataDir)) || GetBoolArg("-choosedatadir", false)) {
        ...
        while (true) {
            ...
            try {
                ...
                QMessageBox::critical(0, tr("CRYPTOCOUPON"),
     ...
     * override -datadir in the cryptocoupon.conf file in the default data directory
     * (to be consistent with cryptocoupond behavior)
     */
    if (dataDir != getDefaultDataDirectory())
