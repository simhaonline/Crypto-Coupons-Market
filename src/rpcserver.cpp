...
UniValue stop(const UniValue& params, bool fHelp)
{
    ...
    if (fHelp || params.size() > 1)
        throw runtime_error(
            "stop\n"
            "\nStop CRYPTOCOUPON server.");
    // Shutdown will take long enough that the response should get back
    StartShutdown();
    return "CRYPTOCOUPON server stopping";
}
...
static const CRPCCommand vRPCCommands[] =
    {
        ...
        /* CRYPTOCOUPON features */
        {"CRYPTOCOUPON", "masternode", &masternode, true, true, false},
        {"CRYPTOCOUPON", "listmasternodes", &listmasternodes, true, true, false},
        {"CRYPTOCOUPON", "getmasternodecount", &getmasternodecount, true, true, false},
        {"CRYPTOCOUPON", "masternodeconnect", &masternodeconnect, true, true, false},
        {"CRYPTOCOUPON", "masternodecurrent", &masternodecurrent, true, true, false},
        {"CRYPTOCOUPON", "masternodedebug", &masternodedebug, true, true, false},
        {"CRYPTOCOUPON", "startmasternode", &startmasternode, true, true, false},
        {"CRYPTOCOUPON", "createmasternodekey", &createmasternodekey, true, true, false},
        {"CRYPTOCOUPON", "getmasternodeoutputs", &getmasternodeoutputs, true, true, false},
        {"CRYPTOCOUPON", "listmasternodeconf", &listmasternodeconf, true, true, false},
        {"CRYPTOCOUPON", "getmasternodestatus", &getmasternodestatus, true, true, false},
        {"CRYPTOCOUPON", "getmasternodewinners", &getmasternodewinners, true, true, false},
        {"CRYPTOCOUPON", "getmasternodescores", &getmasternodescores, true, true, false},
        {"CRYPTOCOUPON", "mnbudget", &mnbudget, true, true, false},
        {"CRYPTOCOUPON", "preparebudget", &preparebudget, true, true, false},
        {"CRYPTOCOUPON", "submitbudget", &submitbudget, true, true, false},
        {"CRYPTOCOUPON", "mnbudgetvote", &mnbudgetvote, true, true, false},
        {"CRYPTOCOUPON", "getbudgetvotes", &getbudgetvotes, true, true, false},
        {"CRYPTOCOUPON", "getnextsuperblock", &getnextsuperblock, true, true, false},
        {"CRYPTOCOUPON", "getbudgetprojection", &getbudgetprojection, true, true, false},
        {"CRYPTOCOUPON", "getbudgetinfo", &getbudgetinfo, true, true, false},
        {"CRYPTOCOUPON", "mnbudgetrawvote", &mnbudgetrawvote, true, true, false},
        {"CRYPTOCOUPON", "mnfinalbudget", &mnfinalbudget, true, true, false},
        {"CRYPTOCOUPON", "checkbudgets", &checkbudgets, true, true, false},
        {"CRYPTOCOUPON", "mnsync", &mnsync, true, true, false},
        {"CRYPTOCOUPON", "spork", &spork, true, true, false},
#ifdef ENABLE_WALLET
...
{
    return "> CRYPTOCOUPON-cli " + methodname + " " + args + "\n";
}
...
std::string HelpExampleRpc(string methodname, string args)
{
    return "> curl --user myusername --data-binary '{\"jsonrpc\": \"1.0\", \"id\":\"curltest\", "
           "\"method\": \"" +
           methodname + "\", \"params\": [" + args + "] }' -H 'content-type: text/plain;' http://127.0.0.1:28230/\n";
}
